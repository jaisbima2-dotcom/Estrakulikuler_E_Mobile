...
const coaches = [
  {
    role: "Pembina",
    roleColor: "blue",
    name: "Kiki Amrullah, S.Pd.",
    desc: "Pembina ekstrakurikuler badminton sejak 2015. Berpengalaman membimbing lebih dari 45 siswa berprestasi.",
    initials: "KA",
  },
  {
    role: "Pelatih Utama",
    roleColor: "orange",
    name: "Alfi, S.Kom.",
    desc: "Mantan atlet badminton profesional liga daerah. Spesialis pelatihan teknik dan strategi permainan.",
    initials: "AF",
  },
];
...
const achievements = [
  ...
  {
    title: "Juara 2 Kompetisi Badminton Pelajar Bogor",
    sub: "Kabupaten",
    year: "2023",
    medal: "silver",
  },
  {
    title: "Juara 1 Turnamen Badminton Antar SMK Se-Cibinong",
    sub: "Kecamatan",
    year: "2022",
    medal: "gold",
  },
  ...
  {
    title: "Best Player — Maulana (XII TKJ)",
        ...
        <section className="section-about">
          <div className="container-md">
            ...
            <p className="about-para">
              ...
              teknik dasar seperti servis, smash, dropshot, footwork, dan
              strategi permainan melalui latihan rutin yang dibimbing oleh
              pelatih maupun pembina. Selain meningkatkan kemampuan bermain,
            ...
            <p className="about-para">
              ...
              pertandingan internal, hingga mengikuti turnamen dapat memberikan
              pengalaman berharga serta meningkatkan rasa percaya diri anggota.
              Dengan suasana latihan yang aktif dan penuh semangat, eskul
              badminton menjadi tempat yang tepat untuk mengembangkan kemampuan
              sekaligus mempererat kebersamaan antaranggota.
            </p>
          </div>
        </section>
            ...
            <div className="footer-grid">
              ...
              <div className="footer-col">
                ...
                <p className="footer-location-note">
                  ...
                  Lapangan badminton SMKN 1 Cibinong
                </p>
              </div>
              ...
              <div className="footer-col">
                ...
                <ul className="footer-contact-list">
                  ...
                  <li className="footer-contact-item">
                    ...
                    <span>badminton@smkn1cibinong.sch.id</span>
                  </li>
                </ul>
              </div>
            </div>
