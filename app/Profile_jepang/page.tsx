    ...
    <>
      ...
      <section className="relative h-screen min-h-[680px] flex items-center overflow-hidden" style={{ paddingTop: "80px" }}>
        ...
        <div
          ...
          style={{
            backgroundImage: "url('/jepang.jpg')",
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 w-full grid gap-12 items-center hero-content">
          ...
          <div className="space-y-8 hero-left">
            ...
            >
              ...
              di bidang olahraga jepang. Bersama kami, cetak sejarahmu di
              lapangan.
            </p>
      ...
      <main className="page-root">
        ...
        <section className="section-about">
          <div className="container-md">
            <div className="about-badge">Ekstrakurikuler Jepang</div>
            <h1 className="about-title">Tentang Kami</h1>
            <p className="about-para">
              Ekstrakurikuler Japanese Club merupakan kegiatan yang menjadi
              wadah bagi siswa untuk mengenal dan mempelajari bahasa serta
              budaya Jepang. Dalam kegiatan ini, anggota akan belajar
              dasar-dasar bahasa Jepang seperti huruf hiragana, katakana,
              kosakata, percakapan sederhana, hingga budaya Jepang melalui
              berbagai aktivitas menarik dan interaktif. Kegiatan ini membantu
              siswa menambah wawasan sekaligus meningkatkan minat belajar bahasa
              asing.
            </p>
            <p className="about-para">
              Tidak hanya belajar bahasa, Japanese Club juga menghadirkan
              berbagai kegiatan budaya seperti pengenalan anime, manga, musik
              Jepang, cosplay, hingga festival budaya Jepang. Melalui kegiatan
              tersebut, anggota dapat mengembangkan kreativitas, rasa percaya
              diri, dan kemampuan bekerja sama dengan sesama anggota. Dengan
              suasana belajar yang santai dan menyenangkan, Japanese Club
              menjadi tempat yang tepat untuk menyalurkan minat terhadap budaya
              dan bahasa Jepang.
            </p>
          </div>
        </section>
          ...
          <div className="footer-container">
              ...
              <div className="footer-col">
                ...
                <ul className="footer-contact-list">
                  ...
                  <li className="footer-contact-item">
                    ...
                    <span>jepang@smkn1cibinong.sch.id</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="footer-bottom">
              <p className="footer-bottom-left">
                © 2025 Ekstrakurikuler Jepang SMKN 1 Cibinong. Semua hak
                dilindungi.
              </p>
            </div>
          </div>
