        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 w-full grid gap-12 items-center hero-content">
          ...
          <div className="space-y-8 hero-left">
            ...
            >
              ...
              di bidang kesehatan dan kebugaran PMR. Bersama kami, cetak
              sejarahmu di lapangan.
            </p>
        ...
        <section className="section-about">
          <div className="container-md">
            ...
            <p className="about-para">
              Ekstrakurikuler Palang Merah Remaja (PMR) merupakan kegiatan yang
              berfokus pada pendidikan kesehatan, kepedulian sosial, dan
              keterampilan pertolongan pertama. Dalam kegiatan ini, anggota akan
              mempelajari dasar-dasar pertolongan pertama, perawatan kesehatan,
              donor darah, serta penanganan kondisi darurat dengan bimbingan
              pembina dan tenaga yang berpengalaman. Kegiatan ini membantu siswa
              memiliki pengetahuan dasar dalam membantu sesama.
            </p>
            <p className="about-para">
              Melalui PMR, siswa juga diajarkan nilai kemanusiaan, kerja sama,
              disiplin, dan rasa peduli terhadap lingkungan sekitar. Berbagai
              kegiatan sosial, pelatihan kesehatan, dan bakti kemanusiaan
              memberikan pengalaman yang bermanfaat sekaligus meningkatkan rasa
              tanggung jawab anggota. Dengan suasana belajar yang aktif dan
              penuh kepedulian, PMR menjadi wadah yang tepat untuk membentuk
              jiwa sosial dan empati siswa.
            </p>
          </div>
        </section>
          ...
          <div className="container-md">
            <div className="achievements-header">
              ...
              <p className="achievements-subtitle">
                Rekam jejak terbaik PMR SMKN 1 Cibinong di berbagai kompetisi
              </p>
            </div>
          ...
          <div className="footer-container">
            <div className="footer-grid">
              ...
              <div className="footer-col">
                <div className="footer-brand">
                  ...
                  <span className="footer-brand-name">PMR SMKN 1 Cibinong</span>
                </div>
              ...
              <div className="footer-col">
                ...
                <ul className="footer-contact-list">
                  ...
                  <li className="footer-contact-item">
                    ...
                    <span>pmr@smkn1cibinong.sch.id</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="footer-bottom">
              <p className="footer-bottom-left">
                © 2025 Ekstrakurikuler PMR SMKN 1 Cibinong. Semua hak
                dilindungi.
              </p>
            </div>
          </div>
