        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 w-full grid gap-12 items-center hero-content">
          ...
          <div className="space-y-8 hero-left">
            ...
            >
              ...
              di bidang kerohanian Kristen. Bersama kami, cetak sejarahmu di
              lapangan.
            </p>
      ...
      <main className="page-root">
        ...
        <section className="section-about">
          <div className="container-md">
            <div className="about-badge">Ekstrakurikuler Rohani kristen</div>
            <h1 className="about-title">Tentang Kami</h1>
            <p className="about-para">
              Ekstrakurikuler Rokris merupakan wadah bagi siswa Kristen untuk
              memperdalam iman, memperkuat karakter rohani, dan membangun
              kebersamaan dalam lingkungan sekolah. Kegiatan yang dilakukan
              meliputi ibadah bersama, pendalaman Alkitab, doa, pujian, serta
              diskusi rohani yang membantu siswa memahami nilai-nilai kehidupan
              berdasarkan ajaran Kristiani. Melalui kegiatan ini, anggota dapat
              bertumbuh secara spiritual sekaligus mempererat hubungan
              antaranggota.
            </p>
            <p className="about-para">
              Selain kegiatan kerohanian, Rokris juga mengadakan berbagai
              kegiatan sosial dan pelayanan yang melatih kepedulian, tanggung
              jawab, dan kerja sama. Dengan suasana yang hangat dan penuh
              dukungan, anggota diajak untuk menjadi pribadi yang lebih percaya
              diri, disiplin, dan memiliki sikap toleransi yang baik. Rokris
              menjadi tempat yang tepat untuk mengembangkan iman serta membangun
          ...
          <div className="container-md">
            <div className="achievements-header">
              ...
              <p className="achievements-subtitle">
                Rekam jejak terbaik Rohani Kristen SMKN 1 Cibinong di berbagai
                kompetisi
              </p>
            </div>
          ...
          <div className="footer-container">
              ...
              <div className="footer-col">
                <div className="footer-brand">
                  ...
                  <span className="footer-brand-name">
                    Rohani Kristen SMKN 1 Cibinong
                  </span>
                </div>
              ...
              <div className="footer-col">
                ...
                <ul className="footer-contact-list">
                  ...
                  <li className="footer-contact-item">
                    ...
                    <span>rokris@smkn1cibinong.sch.id</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="footer-bottom">
              <p className="footer-bottom-left">
                © 2025 Ekstrakurikuler rokris SMKN 1 Cibinong. Semua hak
                dilindungi.
              </p>
            </div>
          </div>
