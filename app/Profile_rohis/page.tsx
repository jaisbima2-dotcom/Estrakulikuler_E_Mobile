        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 w-full grid gap-12 items-center hero-content">
          ...
          <div className="space-y-8 hero-left">
            ...
            >
              ...
              di bidang kerohanian Rohis. Bersama kami, cetak sejarahmu di
              lapangan.
            </p>
      ...
      <main className="page-root">
        ...
        <section className="section-about">
          <div className="container-md">
            <div className="about-badge">Ekstrakurikuler Rohani islam</div>
            <h1 className="about-title">Tentang Kami</h1>
            <p className="about-para">
              Ekstrakurikuler Rohis merupakan kegiatan keagamaan yang bertujuan
              untuk meningkatkan pemahaman, keimanan, dan ketakwaan siswa dalam
              ajaran Islam. Kegiatan yang dilakukan meliputi kajian keislaman,
              membaca Al-Qur’an, ceramah, diskusi, serta berbagai kegiatan
              sosial dan keagamaan lainnya. Melalui kegiatan ini, siswa dapat
              memperdalam ilmu agama sekaligus membangun lingkungan yang positif
              dan religius.
            </p>
            <p className="about-para">
              Selain memperkuat nilai spiritual, Rohis juga membantu membentuk
              karakter siswa agar lebih disiplin, bertanggung jawab, dan
              memiliki akhlak yang baik. Berbagai kegiatan seperti pesantren
              kilat, peringatan hari besar Islam, dan bakti sosial menjadi
              pengalaman yang bermanfaat bagi anggota. Dengan suasana yang penuh
              kebersamaan, Rohis menjadi wadah yang tepat untuk mengembangkan
          ...
          <div className="container-md">
            <div className="achievements-header">
              ...
              <p className="achievements-subtitle">
                Rekam jejak terbaik rohis SMKN 1 Cibinong di berbagai kompetisi
              </p>
            </div>
          ...
          <div className="footer-container">
              ...
              <div className="footer-col">
                ...
                <ul className="footer-contact-list">
                  ...
                  <li className="footer-contact-item">
                    ...
                    <span>rdmmilenium@smkn1cibinong.sch.id</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="footer-bottom">
              <p className="footer-bottom-left">
                © 2025 Ekstrakurikuler Rohis SMKN 1 Cibinong. Semua hak
                dilindungi.
              </p>
            </div>
          </div>
