        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 w-full grid gap-12 items-center hero-content">
          ...
          <div className="space-y-8 hero-left">
            ...
            >
              ...
              di bidang olahraga paskibra. Bersama kami, cetak sejarahmu di
              lapangan.
            </p>
      ...
      <main className="page-root">
        ...
        <section className="section-about">
          <div className="container-md">
            <div className="about-badge">Ekstrakurikuler Paskibra</div>
            <h1 className="about-title">Tentang Kami</h1>
            <p className="about-para">
              Ekstrakurikuler Paskibra merupakan kegiatan yang berfokus pada
              pelatihan baris-berbaris, kedisiplinan, dan jiwa kepemimpinan
              siswa. Dalam kegiatan ini, anggota akan dilatih mengenai tata
              upacara bendera, kekompakan tim, serta ketegasan dalam bertindak
              dengan bimbingan pelatih dan pembina. Latihan rutin dilakukan
              untuk membentuk fisik yang kuat, mental yang disiplin, dan rasa
              tanggung jawab yang tinggi.
            </p>
            <p className="about-para">
              Melalui Paskibra, siswa juga belajar tentang kerja sama,
              nasionalisme, dan semangat cinta tanah air. Berbagai kegiatan
              seperti latihan gabungan, lomba baris-berbaris, dan pengibaran
              bendera pada upacara sekolah memberikan pengalaman berharga bagi
              anggota. Dengan latihan yang teratur dan penuh semangat, Paskibra
              menjadi wadah yang tepat untuk membentuk karakter siswa yang
              disiplin dan berjiwa pemimpin.
            </p>
          </div>
        </section>
          ...
          <div className="container-md">
            <div className="achievements-header">
              ...
              <p className="achievements-subtitle">
                Rekam jejak terbaik Paskibra SMKN 1 Cibinong di berbagai
                kompetisi
              </p>
            </div>
          ...
          <div className="footer-container">
              ...
              <div className="footer-col">
                ...
                <ul className="footer-contact-list">
                  ...
                  <li className="footer-contact-item">
                    ...
                    <span>paskibra@smkn1cibinong.sch.id</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="footer-bottom">
              <p className="footer-bottom-left">
                © 2025 Ekstrakurikuler Paskibra SMKN 1 Cibinong. Semua hak
                dilindungi.
              </p>
            </div>
          </div>
