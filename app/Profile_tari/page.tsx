        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 w-full grid gap-12 items-center hero-content">
          ...
          <div className="space-y-8 hero-left">
            ...
            >
              ...
              di bidang kesenian yaitu tari. Bersama kami, cetak sejarahmu di
              lapangan.
            </p>
      ...
      <main className="page-root">
        ...
        <section className="section-about">
          <div className="container-md">
            <div className="about-badge">Ekstrakurikuler Tari</div>
            <h1 className="about-title">Tentang Kami</h1>
            <p className="about-para">
              Ekstrakurikuler tari merupakan kegiatan yang menjadi wadah bagi
              siswa untuk mengembangkan minat dan bakat di bidang seni tari.
              Dalam kegiatan ini, anggota akan mempelajari berbagai jenis
              tarian, baik tradisional maupun modern, serta teknik gerakan,
              ekspresi, dan kekompakan dalam penampilan. Latihan rutin dilakukan
              untuk meningkatkan kemampuan menari sekaligus melatih kelenturan
              dan kepercayaan diri siswa.
            </p>
            <p className="about-para">
              Selain mengembangkan keterampilan seni, eskul tari juga membantu
              siswa meningkatkan kreativitas, disiplin, dan kemampuan bekerja
              sama dalam tim. Berbagai kegiatan seperti penampilan seni, lomba
              tari, dan pentas sekolah memberikan pengalaman berharga bagi
              anggota untuk menunjukkan bakat mereka di depan umum. Dengan
              suasana latihan yang menyenangkan dan penuh kreativitas, eskul
              tari menjadi tempat yang tepat untuk mengekspresikan diri melalui
              seni.
            </p>
          </div>
        </section>
          ...
          <div className="container-md">
            <div className="achievements-header">
              ...
              <p className="achievements-subtitle">
                Rekam jejak terbaik tari SMKN 1 Cibinong di berbagai kompetisi
              </p>
            </div>
          ...
          <div className="footer-container">
              ...
              <div className="footer-col">
                ...
                <ul className="footer-contact-list">
                  ...
                  <li className="footer-contact-item">
                    ...
                    <span>tari@smkn1cibinong.sch.id</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="footer-bottom">
              <p className="footer-bottom-left">
                © 2025 Ekstrakurikuler Tari SMKN 1 Cibinong. Semua hak
                dilindungi.
              </p>
            </div>
          </div>
