        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 w-full grid gap-12 items-center hero-content">
          ...
          <div className="space-y-8 hero-left">
            ...
            >
              ...
              di bidang 3P pramuka. Bersama kami, cetak sejarahmu di
              lapangan.
            </p>
      ...
      <main className="page-root">
        ...
        <section className="section-about">
          <div className="container-md">
            <div className="about-badge">Ekstrakurikuler Pramuka</div>
            <h1 className="about-title">Tentang Kami</h1>
            <p className="about-para">
              Ekstrakurikuler Pramuka merupakan kegiatan yang bertujuan untuk
              membentuk karakter siswa agar mandiri, disiplin, dan bertanggung
              jawab melalui berbagai aktivitas edukatif dan menyenangkan. Dalam
              kegiatan ini, anggota akan belajar keterampilan seperti
              tali-temali, baris-berbaris, pertolongan pertama, navigasi, hingga
              kegiatan alam terbuka yang melatih keberanian dan kerja sama tim.
            </p>
            <p className="about-para">
              Selain meningkatkan keterampilan, Pramuka juga menanamkan nilai
              kepemimpinan, solidaritas, dan kepedulian sosial kepada sesama.
              Berbagai kegiatan seperti perkemahan, penjelajahan, dan lomba
              kepramukaan memberikan pengalaman berharga serta mempererat
              kebersamaan antaranggota. Dengan suasana yang aktif dan penuh
              tantangan, Pramuka menjadi tempat yang tepat untuk membangun
              karakter dan keterampilan hidup siswa.
            </p>
          </div>
        </section>
          ...
          <div className="container-md">
            <div className="achievements-header">
              ...
              <p className="achievements-subtitle">
                Rekam jejak terbaik Pramuka SMKN 1 Cibinong di berbagai
                kompetisi
              </p>
            </div>
          ...
          <div className="footer-container">
              ...
              <div className="footer-col">
                ...
                <ul className="footer-contact-list">
                  ...
                  <li className="footer-contact-item">
                    ...
                    <span>pramuka@smkn1cibinong.sch.id</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="footer-bottom">
              <p className="footer-bottom-left">
                © 2025 Ekstrakurikuler Pramuka SMKN 1 Cibinong. Semua hak
                dilindungi.
              </p>
            </div>
          </div>
