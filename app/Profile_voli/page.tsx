        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 w-full grid gap-12 items-center hero-content">
          ...
          <div className="space-y-8 hero-left">
            ...
            >
              ...
              di bidang olahraga bola voli. Bersama kami, cetak sejarahmu di
              lapangan.
            </p>
      ...
      <main className="page-root">
        ...
        <section className="section-about">
          <div className="container-md">
            <div className="about-badge">Ekstrakurikuler Voli</div>
            <h1 className="about-title">Tentang Kami</h1>
            <p className="about-para">
              Ekstrakurikuler voli merupakan kegiatan yang menjadi wadah bagi
              siswa untuk mengembangkan kemampuan dalam olahraga bola voli.
              Dalam latihan rutin, anggota akan mempelajari teknik dasar seperti
              servis, passing, smash, blocking, dan strategi permainan tim
              dengan bimbingan pelatih maupun pembina. Selain meningkatkan
              kemampuan bermain, eskul voli juga membantu menjaga kebugaran
              tubuh serta melatih kekuatan fisik dan koordinasi.
            </p>
            <p className="about-para">
              Melalui eskul voli, siswa diajarkan pentingnya kerja sama tim,
              disiplin, sportivitas, dan semangat pantang menyerah. Berbagai
              kegiatan seperti sparing, pertandingan, dan turnamen memberikan
              pengalaman berharga sekaligus mempererat kekompakan antaranggota.
              Dengan suasana latihan yang aktif dan penuh semangat, eskul voli
              menjadi tempat yang tepat untuk menyalurkan minat dan bakat di
              bidang olahraga.
            </p>
          </div>
        </section>
          ...
          <div className="container-md">
            <div className="achievements-header">
              ...
              <p className="achievements-subtitle">
                Rekam jejak terbaik Voli SMKN 1 Cibinong di berbagai kompetisi
              </p>
            </div>
          ...
          <div className="footer-container">
              ...
              <div className="footer-col">
                ...
                <ul className="footer-contact-list">
                  ...
                  <li className="footer-contact-item">
                    ...
                    <span>voli@smkn1cibinong.sch.id</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="footer-bottom">
              <p className="footer-bottom-left">
                © 2026 Ekstrakurikuler Voli SMKN 1 Cibinong. Semua hak
                dilindungi.
              </p>
            </div>
          </div>
