      ...
      <div className="footer-container">
        <div className="footer-grid">
          ...
          <div className="footer-col">
            ...
            <ul className="footer-links">
              <li><a href="/">Home</a></li>
              <li><a href="/Profile_eskul">Kategori</a></li>
          ...
          <div className="footer-col">
            ...
            <ul className="footer-contact-list">
              <li className="footer-contact-item">
                <IconLocation />
                <span>Jl. Karadenan No.7, Cibinong, Bogor, Jawa Barat 16913</span>
              </li>
              <li className="footer-contact-item">
                <IconPhone />
              ...
              <li className="footer-contact-item">
                <IconMail />
                <span>basket@smkn1cibinong.sch.id</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="footer-bottom">
          <p className="footer-bottom-left">
            © {new Date().getFullYear()} Ekstrakurikuler SMKN 1 Cibinong. Semua hak dilindungi.
          </p>
        </div>
      </div>
    </footer>
